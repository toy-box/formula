 ...
 * `PowerExpressionParser`.
 */
export interface PowerExpressionParserListener extends ParseTreeListener {
  /**
  ...
  /**
   * Enter a parse tree produced by the `BehaviorExpression`
   * labeled alternative in `PowerExpressionParser.singleExpression`.
   * @param ctx the parse tree
   */
  enterBehaviorExpression?: (ctx: BehaviorExpressionContext) => void;
  /**
   * Exit a parse tree produced by the `BehaviorExpression`
   * labeled alternative in `PowerExpressionParser.singleExpression`.
   * @param ctx the parse tree
   */
  exitBehaviorExpression?: (ctx: BehaviorExpressionContext) => void;
  ...
  /**
   * Enter a parse tree produced by `PowerExpressionParser.eos`.
   * @param ctx the parse tree
   */
  enterEos?: (ctx: EosContext) => void;
  /**
   * Exit a parse tree produced by `PowerExpressionParser.eos`.
   * @param ctx the parse tree
   */
